          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                />
                <button type="button" className="absolute inset-y-0 right-0 px-3 py-2 text-blue-500 text-sm focus:outline-none">
                  Exibir
                </button>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button type="submit" className="w-full bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Iniciar sessão
              </button>
            </div>
          </form>
