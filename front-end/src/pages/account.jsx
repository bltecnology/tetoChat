...
const Account = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get('https://ec2-52-67-45-214.sa-east-1.compute.amazonaws.com/me');
    ...
    const handlePasswordChange = async () => {
        ...
        try {
            await axios.put('https://ec2-52-67-45-214.sa-east-1.compute.amazonaws.com/update-password', {
