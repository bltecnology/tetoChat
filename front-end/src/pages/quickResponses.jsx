...
const QuickResponses = () => {
    ...
    useEffect(() => {
        const fetchQuickResponses = async () => {
            try {
                const response = await axios.get('https://ec2-52-67-45-214.sa-east-1.compute.amazonaws.com/quickResponses');
    ...
    const addQuickResponse = async (text, department) => {
        try {
            const response = await axios.post('https://ec2-52-67-45-214.sa-east-1.compute.amazonaws.com/quickResponses', { text, department });
