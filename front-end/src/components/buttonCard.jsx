...
const ButtonCard = ({ icon, text, className }) => {
  return (
    <a href="#_" className={`relative inline-flex items-center justify-center p-6 overflow-hidden font-medium transition-all bg-white text-red-500 rounded-xl group w-48 h-32 ${className}`}>
